...
_pkg_config = {
    'default_bin_dir':  'c:\\dev\\digsby\\build\\msw\\python',
    'default_mod_dir':  'c:\\dev\\digsby\\build\\msw\\python\\Lib\\site-packages',
    'default_sip_dir':  'C:\\dev\\sip\\siplib',
    'export_all':       0,
    'platform':         'win32-msvc.net',
    'py_conf_inc_dir':  'c:\\dev\\digsby\\build\\msw\\python\\PCbuild\\Win32-pgo\\PC',
    'py_inc_dir':       'c:\\dev\\digsby\\build\\msw\\python\\include',
    'py_lib_dir':       'c:\\dev\\digsby\\build\\msw\\python\\PCbuild\\Win32-pgo',
    'py_version':       0x020600,
    'sip_bin':          'C:\\dev\\sip\\sipgen\\sip',
    'sip_config_args':  'build',
    'sip_inc_dir':      'C:\\dev\\sip\\siplib',
    'sip_mod_dir':      'C:\\dev\\sip\\siplib',
...
_default_macros = {
    ...
    'LFLAGS_OPENGL':            '',
    'LFLAGS_PLUGIN':            '',
    'LFLAGS_RELEASE':           '/INCREMENTAL:NO /LTCG',
    'LFLAGS_SHLIB':             '',
    'LFLAGS_SONAME':            '',
    'LFLAGS_THREAD':            '',
    ...
    'LIBS_GUI':                 'gdi32.lib comdlg32.lib oleaut32.lib imm32.lib winmm.lib winspool.lib ws2_32.lib ole32.lib user32.lib',
